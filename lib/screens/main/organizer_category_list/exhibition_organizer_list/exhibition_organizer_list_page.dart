...
import 'package:eventide_app/screens/main/organizer_category_list/exhibition_organizer_list/widgets/exhibition_organizer_listview.dart';
...
class ExhibitionList extends StatefulWidget {
  const ExhibitionList({required this.categoryModel, super.key});
        ...
        body: SizedBox(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 20),
              const Expanded(child: ExhibitionOrganizersList()),
            ],
          ),
        ),
      ),
