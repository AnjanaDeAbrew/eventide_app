...
import 'package:eventide_app/screens/main/organizer_category_list/organizer_list/widgets/organizer_listview.dart';
...
class OrganizerListCategory extends StatefulWidget {
  const OrganizerListCategory({required this.categoryModel, super.key});
  final CategoryModel categoryModel;

  @override
  State<OrganizerListCategory> createState() => _OrganizerListCategoryState();
}

class _OrganizerListCategoryState extends State<OrganizerListCategory> {
