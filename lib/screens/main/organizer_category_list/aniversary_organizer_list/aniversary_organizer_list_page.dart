...
import 'package:eventide_app/screens/main/organizer_category_list/aniversary_organizer_list/widgets/aniversary_organizer_listview.dart';
...
class AniversaryList extends StatefulWidget {
  const AniversaryList({required this.categoryModel, super.key});
  final CategoryModel categoryModel;

  @override
  State<AniversaryList> createState() => _AniversaryListState();
}

class _AniversaryListState extends State<AniversaryList> {
        ...
        body: SizedBox(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 20),
              const Expanded(child: AniversaryOrganizersList()),
            ],
          ),
        ),
      ),
