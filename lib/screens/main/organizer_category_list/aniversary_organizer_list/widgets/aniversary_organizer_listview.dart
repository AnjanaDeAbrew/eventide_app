...
class AniversaryOrganizersList extends StatefulWidget {
  const AniversaryOrganizersList({
    Key? key,
  }) : super(key: key);

  @override
  State<AniversaryOrganizersList> createState() =>
      _AniversaryOrganizersListState();
}

class _AniversaryOrganizersListState extends State<AniversaryOrganizersList> {
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                image:
                                    NetworkImage(value.organizers[index].img),
                                fit: BoxFit.cover),
                          ),
                        ),
                        ...
                        SizedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              CustomText(value.organizers[index].mobile,
                                  fontSize: 14,
                                  color: AppColors.primaryAshThree),
                              CustomText(value.organizers[index].town,
                                  fontSize: 15,
                                  color: AppColors.primaryAshThree),
                            ],
                          ),
